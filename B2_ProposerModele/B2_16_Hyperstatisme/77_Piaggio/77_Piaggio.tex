...
\exer{Scooter Piaggio$\star$ \label{B2:16:77}}
%% 
...
On s'intéresse au système durection du scooter Piaggio.

\begin{figure}[H]
\centering
\includegraphics[width=.45\linewidth]{77_01.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{77_03.png}
%\caption{Pince utilisée sur le système ROBOVOLC et schéma cinématique associé \label{fig_23}}
\end{figure} 
...
\begin{flushright}
\footnotesize{Corrigé  voir \ref{B2:16:77}.}
\end{flushright}%
\fi