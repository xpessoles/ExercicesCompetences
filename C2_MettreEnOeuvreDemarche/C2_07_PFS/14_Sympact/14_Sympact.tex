...
\exer{Barrière Sympact $\star\star$ \label{C2:07:14} A FINIR}
\setcounter{numques}{0}
\UPSTIcompetence{C2-07}
...
\question{Mettre en oeuvre une méthode permettant d'exprimer le couple moteur en fonction des autres actions mécaniques.}
\ifprof
\else
\fi


\question{Tracéer de courbe Python.}
\ifprof
\else
\fi
